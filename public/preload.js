...
contextBridge.exposeInMainWorld('api', {
    send: (channel, data) => {
        ...
        // MTO
        'branchtabledata','import-excel','save-custom-spec','spec-excel-data','update-customspec-table','Mto-doc-save', 'Mto-area-save', 'Mto-tag-save', 'update-mtolinelist-table', 'save-mtoline-area', 'save-material-data'
    ...
    receive: (channel, func) => {
        ...
        // MTO
        'branch-table-response','branch-table-data-response','import-response','specsize-table-response','specmat-table-response','spectemp-table-response', 'specdet-table-response','specdet-detail-response','custom-spec-res','save-doc-mto', 'area-save-mto', 'tag-save-mto', 'linelist-save-mto','mtoline-area-save','material-data-save'
